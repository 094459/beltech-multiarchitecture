...
public class HelloController {
    ...
    public String index() {
	    ...
	    str = str.concat("<span style='color: #000000;font-family:Tahoma'><br><img src='/images/beltech-logo.png' alt='Beltech logo' width='300' height='100'><h1 style='text-align:center'>Demo - Run Anywhere, on Anything</h1>");
